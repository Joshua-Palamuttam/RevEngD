 ...
 * 
 * NOTE: You will need to install Graphviz on your machine for this example to work.
 * Here is the URL: http://www.graphviz.org/download/
 */
public class E5PlantUMLGenerator implements Runnable {
	...
	public void run() {
		...
		try {
			...
			logger.info("Autegenerated diagram stored at: " + filePath.toString());
